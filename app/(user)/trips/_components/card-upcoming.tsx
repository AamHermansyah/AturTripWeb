  ...
  return (
    <div className="relative overflow-hidden rounded-[2rem] w-78 flex flex-col justify-end">
      ...
      <div className="relative flex flex-col gap-3 p-5">
        <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-md px-3 py-1.5 rounded-full w-fit">
        ...
        <div className="flex items-center gap-2 text-white/90">
          ...
          <span className="text-[15px] font-medium tracking-tight">Semarang, Jawa Tengah</span>
        </div>
